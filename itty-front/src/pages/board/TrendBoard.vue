<template>
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <svg
                  ...
                  width="100%"
                  height="100%"
                  src="articles[0]?.trendArticleImageUrl"
                  aria-hidden="true"
                ...
                <div class="container">
                  <div class="carousel-caption text-start">
                    <h1>{{ articles[0]?.trendArticleTitle }}</h1>
                    <p class="opacity-75">
                      {{ articles[0]?.trendArticleContent }}
                    </p>
                  </div>
                </div>
              </div>
              <div class="carousel-item">
                ...
                <div class="container">
                  <div class="carousel-caption text-start">
                    <h1>{{ articles[1]?.trendArticleTitle }}</h1>
                    <p>
                        {{ articles[1]?.trendArticleContent }}
                    </p>
                  </div>
                </div>
              </div>
              <div class="carousel-item">
                ...
                <div class="container">
                  <div class="carousel-caption text-start">
                    <h1>{{ articles[2]?.trendArticleTitle }}</h1>
                    <p>
                        {{ articles[2]?.trendArticleContent }}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div class="product-item">
                          <span
                            :class="getBadgeClass(article.trendArticleCategory)"
                            class="badge position-absolute m-1"
                            >{{ article.trendArticleCategory }}</span>
                          <figure>
                            <a
                              :href="article.trendArticleUrl"
                              title="Product Title"
                            >
                              <img
                                :src="article.trendArticleImageUrl"
                                class="tab-image"
                              />
                            </a>
                          </figure>
                          <h3>{{ article.trendArticleTitle }}</h3>
                          <span class="qty">{{
                            truncateText(article.trendArticleContent, 30)
                          }}</span>
                        </div>
                      </div>
                    </div>
    ...
    <div id="sidebar">
      <!-- Logo -->
      <h1 id="logo"><a href="#">IT(트렌드) 게시판</a></h1>
      <!-- Nav -->
      <nav id="nav">
        <ul>
...
form select:focus,
form textarea:focus {
  box-shadow: 0px 0px 2px 2px #ffed62;
}
...
#titleBar .toggle:before {
  ...
  height: 30px;
  line-height: 30px;
  background: #ffe96e url("images/bg01.png");
  border-radius: 5px;
  color: #fff;
  text-align: center;
  box-shadow: inset 0px 0px 0px 1px rgba(255, 255, 255, 0.15),
...
@media screen and (max-width: 736px) {
  ...
  #sidebar {
    ...
    box-shadow: inset -1px 0 0 0 rgba(255, 255, 255, 0.15),
      inset -0.1em 0 0.5em 0 rgba(0, 0, 0, 0.25);
  }
}
